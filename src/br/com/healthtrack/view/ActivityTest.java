...
public class ActivityTest {
    public static void main(String[] args) {
        ...
        Activity act1 = new Activity("Corrida", 2, 1);
        Activity act2 = new Activity("Natação", 1, 1);
        Activity act3 = new Activity("Ciclismo", 2, 1);
        Activity act4 = new Activity("Mergulho", 1, 1);
        Activity act5 = new Activity("Corrida", 2, 1);
